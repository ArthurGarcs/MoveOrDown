    ...
    return Material(
      ...
      child: Stack(
        children: [
          ...
          //No método build da GameOverlay,
          // adicione uma seção isMobile que
          // segue o mesmo comportamento descrito na etapa 4:
          // tocar no botão esquerdo invoca moveLeft e no botão direito invoca
          // moveRight. Soltar qualquer um dos botões chama resetDirection() e
          // faz com que a Dash não se mova na horizontal.
          if (isMobile)
           Positioned(
